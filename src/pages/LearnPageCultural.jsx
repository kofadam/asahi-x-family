...
import { BookOpen, ChevronRight, Check, Info, ArrowLeft } from 'lucide-react'
...
const LearnPage = () => {
  ...
  useEffect(() => {
    // If no lessonId provided, redirect to lesson selection
    if (!lessonId) {
      navigate('/lessons')
      return
    }
    ...
    setIsLoading(false)
    recordActivity()
  }, [lessonId, navigate, recordActivity])
